...
impl CountmailGame {
    ...
    fn next_question(&mut self) {
        ...
        let letters = rng.gen_range(3..10);
        self.target = letters;
        self.prompt = format!("Remember mail count: {} mail packages. Enter mail count:", letters);
...
impl Default for CountmailGame {
    fn default() -> Self {
        Self::new()
    }
}

impl Game for CountmailGame {

...
impl MorseGame {
    ...
    fn next_question(&mut self) {
        ...
        let morse = vec![("A", 12), ("B", 2111), ("C", 2121), ("D", 211)];
        let idx = rng.gen_range(0..morse.len());
        let q = &morse[idx];
        self.target = q.1;
        self.prompt = format!("What is the digit sequence for morse of \"{}\"? (dot=1, dash=2)", q.0);
...
impl Default for MorseGame {
    fn default() -> Self {
        Self::new()
    }
}

impl Game for MorseGame {

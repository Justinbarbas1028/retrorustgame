...
impl CaesarGame {
    ...
    fn next_question(&mut self) {
        ...
        self.target = shift;
        self.prompt = format!("If A maps to {} (shift key = ?), key is:", (b'A' + shift as u8) as char);
...
impl Default for CaesarGame {
    fn default() -> Self {
        Self::new()
    }
}

impl Game for CaesarGame {

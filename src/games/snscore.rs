...
impl SnscoreGame {
    ...
    fn next_question(&mut self) {
        ...
        self.target = start + step * 3;
        self.prompt = format!("Complete pattern: {}, {}, {}, [?]", start, start+step, start+step*2);
...
impl Default for SnscoreGame {
    fn default() -> Self {
        Self::new()
    }
}

impl Game for SnscoreGame {

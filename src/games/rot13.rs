...
impl Rot13Game {
    ...
    fn next_question(&mut self) {
        ...
        let val = rng.gen_range(10..99);
        self.target = val;
        self.prompt = format!("What is the original number? (Guess target: {})", val);
...
impl Default for Rot13Game {
    fn default() -> Self {
        Self::new()
    }
}

impl Game for Rot13Game {

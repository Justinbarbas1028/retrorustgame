...
impl CfscoresGame {
    ...
    fn next_question(&mut self) {
        ...
        let base = rng.gen_range(10..100);
        self.target = base * 2;
        self.prompt = format!("Compute double of score: {} * 2 = ?", base);
...
impl Default for CfscoresGame {
    fn default() -> Self {
        Self::new()
    }
}

impl Game for CfscoresGame {
